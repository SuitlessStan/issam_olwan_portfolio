export default function Intro() {
    return (
        <div className="container text-center flex flex-col justify-center items-center relative top-20">
            <div className="intro-text my-4">
                <h1 className="text-6xl md:text-7xl my-3 font-Ubuntu block">
                    I am <span className="text-primio">Issam Olwan.</span>
                </h1>
                ...
                <br />
                <span className="my-3 text-2xl">This is my web portfolio!</span>
            </div>
