...
export default function Card({ icon, title, description }: CardProps) {
  return (
    <>
      <div className="container p-5 flex flex-col justify-start bg-gray-300 hover:bg-gray-500 dark:bg-slate-300 dark:hover:bg-slate-600 rounded h-full cursor-text">
